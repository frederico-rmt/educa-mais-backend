...
import pytest
import time
from app.infra.database.pg_driver import PgDriver
from app.application.repository.user_sql_database import UserSqlDatabase
from app.application.usecase.create_user import CreateUser
from app.application.usecase.create_user import CreateUserInput
from app.infra.hasher.bcrypt_driver import BCryptDriver
from app.application.usecase.get_user import GetUser
from app.infra.hasher.hasher_gateway import HasherGateway
...
async def test_create_user(setup_user_data, create_user_usecase):
  ...
  await create_user.execute(input)
